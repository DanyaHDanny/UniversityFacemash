...
### Задачи:
1.[Исследование архитектурного решения](https://github.com/DanyaHDanny/UniversityFacemash/issues/17)
2.[Рефакторинг front-end части приложения](https://github.com/DanyaHDanny/UniversityFacemash/issues/18)

[Backlog](https://github.com/DanyaHDanny/UniversityFacemash/projects/1).
